...
template
__global__ void 
operations_device(std::size_t npx, std::size_t npy, std::size_t xmin, std::size_t xmax, std::size_t ymin, std::size_t ymax, std::size_t zmin, std::size_t zmax, double* device_data_1, double* device_data_2);
